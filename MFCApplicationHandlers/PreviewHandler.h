...
#include <afxext.h>
#include "..\MFCApplication\MFCApplicationDoc.h"
#include "..\MFCApplication\MFCApplicationView.h"
...
protected:
	...
	DECLARE_DOCUMENT(CMFCApplicationDoc)
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CMFCApplicationView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CMFCApplicationDoc, (CObject*) m_pDocument->GetContainer());
